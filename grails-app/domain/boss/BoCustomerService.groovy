...
class BoCustomerService {
  ...
  static constraints = {
    ...
    isFanDian(nullable: true)
    fanDianAmount(nullable: true)
  }

    //def static serviceMap = ['online': '在线支付', 'royalty': '实时分润','agentcoll':'代收','agentpay':'代付','selfSign':'自助签约','precharge':'预付费卡充值']
    def static serviceMap = ['online': '在线支付','agentcoll':'代收','agentpay':'代付']
}
