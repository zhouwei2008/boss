...
class GwOrder {
    ...
    String  id              //    ID	VARCHAR2(22 BYTE)	No	1	 订单主键

    String  service         //    SERVICE	VARCHAR2(64 BYTE)	No	2	服务名 trade_create_by_buyer

    String  outTradeNo           //    ORDERNUM	VARCHAR2(128 BYTE)	No	3	订单号

    String  partnerCustomerNo      //    PARTNERID	VARCHAR2(22 BYTE)	No	4	合作商家客户号

    String  sellerCode       //    SELLER_NAME	VARCHAR2(100 BYTE)	No	5	卖家名称

    String  sellerCustomerNo      //    SELLER_ID	VARCHAR2(22 BYTE)	No	6	卖家(收款)ID

    String  buyerCode       //    BUYER_NAME	VARCHAR2(100 BYTE)	Yes	7	买家名称

    String  buyerCustomerNo   //    BUYER_ID	VARCHAR2(22 BYTE)	Yes	8	买家(付款)ID
...
//    SHOW_URL	VARCHAR2(512 BYTE)	Yes	47	显示URL
    ...
    static statusMap = ['0':'等待买家付款', '1':'等待卖家发货', '2':'等待买家确认货品', '3':'交易完成', '4':'交易失败', '5':'支付失败','6':'支付拒绝']
