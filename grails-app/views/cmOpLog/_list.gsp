<%@ page import="ismp.CmCustomer; ismp.CmOpRelation; boss.BoOpRelation; boss.BoOpLog" %>
...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 colspan=2 width=100 style='height:13.5pt;width:51pt'>商户后台操作日志查询<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'></td>
        ...
        <g:each in="${cmOpLogs}" status="i" var="opLog">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${CmOpRelation.findByActionsAndControllers(opLog.action,opLog.controller)?.names}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${opLog?.customerNo}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${CmCustomer.findByCustomerNo(opLog.customerNo)?.name}</td>
