...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 colspan=2 width=100 style='height:13.5pt;width:51pt'>BOSS后台操作名称管理<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>模块号</td>
            <td class=xl667821 style='border-left:none'>操作号</td>
            <td class=xl667821 style='border-left:none'>描述</td>
        </tr>

        <g:each in="${opRelationList}" status="i" var="opRelation">
            <tr height=18 style='height:13.5pt'>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${i+1}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${opRelation?.controllers}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${opRelation?.actions}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${opRelation?.names}</td>
            </tr>
        </g:each>
