    ...
    <g:form action="save">
        <table align="center" class="rigt_tebl">
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: boOpRelationInstance, field: 'controllers', 'errors')}"><g:textField name="controllers" maxlength="100" value="${boOperatorInstance?.controllers}"/></td>
            </tr>
            <tr>
                <td class="right label_name"><g:message code="boOpRelation.actions.label"/>：</td>
                <td class="${hasErrors(bean: boOpRelationInstance, field: 'actions', 'errors')}"><g:textField name="actions" maxlength="100" value="${boOperatorInstance?.actions}"/></td>
            </tr>
            <tr>
                <td class="right label_name"><g:message code="boOpRelation.names.label"/>：</td>
                <td class="${hasErrors(bean: boOpRelationInstance, field: 'names', 'errors')}"><g:textField name="names" maxlength="100" value="${boOperatorInstance?.names}"/></td>
            </tr>
            <tr>
