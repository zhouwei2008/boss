...
<g:sortableColumn params="${params}"  property="tradeFeetype" title="${message(code: 'tbAgentpayDetailsInfo.tradeFeetype.label', default: '收费方式')}"/>
     ...
     <table align="center">
                ...
                <tr>
                    ...
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgCol_PreChk_Proc}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="frTrialPass" value="初审通过" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgCol_PreChk_Proc}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="frTrialRefuse" value="初审拒绝" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                </tr>
            </table>
             </g:form>
