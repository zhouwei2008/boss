    ...
    <table align="center" class="right_list_table" id="test">
        ...
        %{--<g:sortableColumn params="${params}"  property="tradeRemark2" title="${message(code: 'tbAgentpayDetailsInfo.tradeRemark2.label', default: 'Trade Remark2')}"/>--}%
            ...
            <table align="center">
                ...
                <tr>
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgPay_RfdFinalChk_Pass}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="reTcheck" value="终审通过" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                </tr>
            </table>
        </g:form>
