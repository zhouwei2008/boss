        ...
        <g:hiddenField name="allCheck" id="allCheck"/>
                ...
                <table align="center" class="right_list_table" id="test">
                    ...
                    <g:each in="${tbAgentpayDetailsInfoInstanceList}" status="i" var="tbAgentpayDetailsInfoInstance">
                        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                            ...
                            <td>
                                ${TbAgentpayDetailsInfo.fkYwTypeMap[tbAgentpayDetailsInfoInstance.tradeType]}
                            </td>
            ...
            <table align="center">
                ...
                <tr>
                    ...
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgPay_PreChk_Proc}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="frTrialPass" value="初审通过" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgPay_PreChk_Proc}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="frTrialRefuse" value="初审拒绝" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                </tr>
            </table>
        </g:form>
