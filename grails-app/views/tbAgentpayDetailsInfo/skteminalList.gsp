    ...
    <table align="center" class="right_list_table" id="test">
         <g:form action="skteminalList">
            ...
            业务类型：<g:select name="tradeType" from="${TbAgentpayDetailsInfo.skYwTypeMap}" optionKey="key" optionValue="value" value="${params.tradeType}" noSelection="${['':'-请选择-']}" class="right_top_h2_input"/>
             ...
             付款银行：<g:select name="bankName" from="${bankNameList}" optionKey="bankCode" optionValue="note" noSelection="${['':'--请选择--']}" value="${params.bankName}"/>
      ...
      <g:each in="${tbAgentpayDetailsInfoInstanceList}" status="i" var="tbAgentpayDetailsInfoInstance">
        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
          ...
          <td > ${TbAgentpayDetailsInfo.skYwTypeMap[tbAgentpayDetailsInfoInstance.tradeType]}</td>
     ...
     <table align="center">
          ...
          <g:hiddenField name="flag" value="S"/>
                <tr>
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgCol_FinalChk_Proc}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="terminalPass" value="终审通过" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                    <td align="center">
                        <bo:hasPerm perm="${Perm.AgCol_FinalChk_Proc}"><g:actionSubmit id="submit" align="center" class="right_top_h2_button_tj" action="terminalRefuse" value="终审拒绝" onclick="return selectCheck();"/></bo:hasPerm>
                    </td>
                </tr>
            </table>
             </g:form>
