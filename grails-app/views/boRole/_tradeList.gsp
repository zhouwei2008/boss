...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>人员角色<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            <td height=18 class=xl667821 style='height:13.5pt'>ID</td>
            <td class=xl667821 style='border-left:none'>角色编码</td>
            <td class=xl667821 style='border-left:none'>角色名称</td>
            <td class=xl667821 style='border-left:none'>状态</td>
        </tr>
        <g:each in="${boRoleInstanceList}" status="i" var="boRoleInstance">
            <tr height=18 style='height:13.5pt'>
                <td height=18 class=xl733956 align=right style='height:13.5pt;'>${boRoleInstance.id}</td>
                <td class=xl677821 align=right style='border-left:none'>${boRoleInstance.roleCode}</td>
                <td class=xl707821 style='border-left:none'>${boRoleInstance.roleName}</td>
                <td class=xl707821 style='border-left:none'>${BoRole.statusMap[boRoleInstance?.status]}</td>
            </tr>
        </g:each>
