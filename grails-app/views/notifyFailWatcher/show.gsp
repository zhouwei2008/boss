...
<div class="main">
    ...
    <table align="center" class="rigt_tebl">
        ...
        <tr>
            ...
            <td><span class="rigt_tebl_font">${fieldValue(bean: notifyFailWatcherInstance, field: "name")}</span></td>
        ...
        <tr>
            ...
            <td><span class="rigt_tebl_font">${fieldValue(bean: notifyFailWatcherInstance, field: "mobile")}</span></td>
        ...
        <tr>
            ...
            <td><span class="rigt_tebl_font">${fieldValue(bean: notifyFailWatcherInstance, field: "email")}</span></td>
        ...
        <tr>
            <td colspan="2" align="center">
                <g:form>
                    ...
                    <bo:hasPerm perm="${Perm.InterruptOrder_Watcher_Update}">
                    ...
                    <bo:hasPerm perm="${Perm.InterruptOrder_Watcher_Del}">
