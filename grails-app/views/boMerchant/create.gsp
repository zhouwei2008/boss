...
<div class="main">
  ...
  <g:form action="save" name="save">
    <g:hiddenField name="acquirerAccount.id" value="${params['acquirerAccount.id']}"/>
    <table align="center" class="rigt_tebl">
      ...
      <tr>
        ...
        <td class="${hasErrors(bean: boMerchantInstance, field: 'dayQutor', 'errors')}"><g:textField name="dayQutor" maxlength="10" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value="${fieldValue(bean: boMerchantInstance, field: 'dayQutor')}"/></td>
      </tr>

      <tr>
        <td class="right label_name"><g:message code="boMerchant.qutor.label"/>(元)<font color="red">*</font>：</td>
        <td class="${hasErrors(bean: boMerchantInstance, field: 'qutor', 'errors')}"><g:textField name="qutor" maxlength="10" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" value="${fieldValue(bean: boMerchantInstance, field: 'qutor')}"/></td>
      </tr>
