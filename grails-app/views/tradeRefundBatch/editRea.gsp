        ...
        <table align="center" class="rigt_tebl">
            ...
            <tr>
                <td colspan="2" align="center">
                    <span class="content"><input type="button" onclick="checkReason('<%=request.getParameter("id")%>', '<%=request.getParameter("refundBatchNo")%>')" id="button" class="rigt_button" value="确认"></span>
...
<script type="text/javascript">
    function checkReason(id, refundBatchNo) {
        ...
        window.parent.location.href = '${createLink(controller:'tradeRefundBatch', action:'selectCheckRefuse', params:['flag':'0'])}&id=' + id + '&refundBatchNo=' + refundBatchNo + '&note=' + note;
