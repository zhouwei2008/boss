    ...
    <g:form action="update">
        ...
        <table align="center" class="rigt_tebl">
            ...
            %{--<tr>--}%
                ...
                %{--<td class="${hasErrors(bean: boBranchCompanyInstance, field: 'companyNo', 'errors')}"><g:textField name="companyNo" maxlength="100" value="${boBranchCompanyInstance?.companyNo}"/></td>--}%
            %{--</tr>--}%
            <tr>
                <td class="right label_name"><g:message code="boBranchCompany.companyName.label"/>：<span class="required">*</span></td>
                <td class="${hasErrors(bean: boBranchCompanyInstance, field: 'companyName', 'errors')}"><g:textField name="companyName" maxlength="100" value="${boBranchCompanyInstance?.companyName}"/>最多输入100个字符</td>
            </tr>
            <tr>
                <td class="right label_name"><g:message code="boBranchCompany.chargeMan.label"/>：</td>
                <td class="${hasErrors(bean: boBranchCompanyInstance, field: 'chargeMan', 'errors')}"><g:textField name="chargeMan" maxlength="100" value="${boBranchCompanyInstance?.chargeMan}"/>最多输入100个字符</td>
            </tr>
            <tr>
                <td class="right label_name"><g:message code="boBranchCompany.phone.label"/>：</td>
                <td class="${hasErrors(bean: boBranchCompanyInstance, field: 'phone', 'errors')}"><g:textField name="phone" maxlength="100" value="${boBranchCompanyInstance?.phone}"/>最多输入100个字符</td>
            </tr>
            <tr>
                <td class="right label_name"><g:message code="boBranchCompany.fax.label"/>：</td>
                <td class="${hasErrors(bean: boBranchCompanyInstance, field: 'fax', 'errors')}"><g:textField name="fax" maxlength="100" value="${boBranchCompanyInstance?.fax}"/>最多输入100个字符</td>
            </tr>
            <tr>
                <td class="right label_name"><g:message code="boBranchCompany.address.label"/>：</td>
                <td class="${hasErrors(bean: boBranchCompanyInstance, field: 'address', 'errors')}"><g:textField name="address" maxlength="100" value="${boBranchCompanyInstance?.address}"/>最多输入100个字符</td>
            </tr>
            <tr>
