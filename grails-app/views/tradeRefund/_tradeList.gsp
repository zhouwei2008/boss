    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            <g:if test="${flag=='0'}">
                ...
                width:51pt;text-align:center'><font size="5"><b>待处理退款请求</b></font></td>
            </g:if>
            <g:if test="${flag=='1'}">
                <td height=28 class=xl637821 colspan=13 width=100 style='height:18.5pt;
                width:51pt;text-align:center'><font size="5"><b>单笔退款审批</b></font></td>
            </g:if>
            <g:if test="${flag=='2'}">
                <td height=28 class=xl637821 colspan=14 width=100 style='height:18.5pt;
                width:51pt;text-align:center'><font size="5"><b>批量退款审批</b></font></td>
            </g:if>
            <g:if test="${flag=='3'}">
                <td height=28 class=xl637821 colspan=16 width=100 style='height:18.5pt;
                width:51pt;text-align:center'><font size="5"><b>退款处理</b></font></td>
            </g:if>
            <g:if test="${flag=='4'}">
                <td height=28 class=xl637821 colspan=18 width=100 style='height:18.5pt;
                width:51pt;text-align:center'><font size="5"><b>退款复核</b></font></td>
            </g:if>
            <g:if test="${flag=='5'}">
                <td height=28 class=xl637821 colspan=14 width=100 style='height:18.5pt;
                width:51pt;text-align:center'><font size="5"><b>退款历史查询</b></font></td>
            </g:if>
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 style='height:13.5pt'>汇总信息${flag} </td>
            <td class=xl637821 colspan="2">退款金额汇总（元）：${refundAmount == null ? 0 : refundAmount / 100}</td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>退款申请时间</td>

            <td class=xl667821 style='border-left:none'>原交易时间</td>

            <g:if test="${flag!='0'}">
                <td class=xl667821 style='border-left:none'>退款初审时间</td>
                <td class=xl667821 style='border-left:none'>初审人</td>
            </g:if>
            <g:if test="${flag=='3' || flag=='4' || flag=='5'}">
                <td class=xl667821 style='border-left:none'>退款终审时间</td>
                <td class=xl667821 style='border-left:none'>终审人</td>
            </g:if>

            <g:if test="${flag=='4' || flag=='5'}">
                <td class=xl667821 style='border-left:none'>退款处理时间</td>
                <td class=xl667821 style='border-left:none'>处理人</td>
            </g:if>
            <g:if test="${flag=='0' || flag=='3' || flag=='4'}">
        ...
        <g:each in="${tradeRefundInstanceList}" status="i" var="tradeRefundInstance">
            <tr height=18 style='height:13.5pt'>
                ...
                <td class=xl707821 style='border-left:none'>${TradeCharge.findByRootId(tradeRefundInstance.rootId)?.outTradeNo}</td>
                <g:if test="${flag=='0' && tradeRefundInstance.acquirerMerchantNo!=null}">
                ...
                <g:if test="${tradeRefundInstance.partnerId==null}">
                    <td class=xl707821 align=right style='border-left:none'>
                ...
                <g:else>
                    <td class=xl707821 align=right style='border-left:none'></td>
                </g:else>
                <g:if test="${flag=='0'}">
                    <td class=xl707821 align=right style='border-left:none'>${AppNote.findByAppIdAndAppName(tradeRefundInstance.id, 'tradeRefund_first')?.appNote}</td>
                </g:if>
                <g:if test="${flag!='0'}">
                    <td class=xl707821 align=right style='border-left:none'><g:formatDate date="${tradeRefundInstance?.firstAppDate}" format="yyyy-MM-dd HH:mm:ss"/></td>
                    <td class=xl707821 align=right style='border-left:none'>${tradeRefundInstance?.firstAppName}</td>
                </g:if>
                <g:if test="${flag=='3'}">
                    <td class=xl707821 align=right style='border-left:none'><g:formatDate date="${tradeRefundInstance?.lastAppDate}" format="yyyy-MM-dd HH:mm:ss"/></td>
                    <td class=xl707821 align=right style='border-left:none'>${tradeRefundInstance?.lastAppName}</td>
                    <td class=xl707821 align=right style='border-left:none'>${AppNote.findByAppIdAndAppName(tradeRefundInstance.id, 'tradeRefund_last')?.appNote}</td>
                </g:if>
                <g:if test="${flag=='4'}">
                    <td class=xl707821 align=right style='border-left:none'><g:formatDate date="${tradeRefundInstance?.lastAppDate}" format="yyyy-MM-dd HH:mm:ss"/></td>
                    <td class=xl707821 align=right style='border-left:none'>${tradeRefundInstance?.lastAppName}</td>
                    <td class=xl707821 align=right style='border-left:none'><g:formatDate date="${tradeRefundInstance?.refundHandleDate}" format="yyyy-MM-dd HH:mm:ss"/></td>
                    <td class=xl707821 align=right style='border-left:none'>${tradeRefundInstance?.refundHandleName}</td>
                    <td class=xl707821 align=right style='border-left:none'>${AppNote.findByAppIdAndAppName(tradeRefundInstance.id, 'tradeRefund_second')?.appNote}</td>
                </g:if>
