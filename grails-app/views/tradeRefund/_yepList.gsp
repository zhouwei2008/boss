...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            <td class=xl667821 style='border-left:none'>订单号</td>
            <td class=xl667821 style='border-left:none'>支付日期</td>
            <td class=xl667821 style='border-left:none'>充值退回金额</td>
            <td class=xl667821 style='border-left:none'>退款号</td>
            <td class=xl667821 style='border-left:none'>扩展信息</td>
            <td class=xl667821 style='border-left:none'>扩展信息</td>
        </tr>
        <g:each in="${tradeRefundInstanceList}" status="i" var="tradeRefundInstance">
            <tr height=18 style='height:13.5pt'>
                <td class=xl707821 align=right style='border-left:none'>${GwTransaction.get(TradeCharge.findByRootId(tradeRefundInstance.rootId)?.tradeNo)?.bankTransNo}</td>
                <td class=xl707821 style='border-left:none'><g:formatDate date="${tradeRefundInstance.dateCreated}" format="yyyy-MM-dd"/></td>
                <td class=xl727821 style='border-left:none'>${tradeRefundInstance?.amount ? tradeRefundInstance?.amount/100: 0}</td>
                <td class=xl707821 align=right style='border-left:none'>${tradeRefundInstance.outTradeNo}</td>
