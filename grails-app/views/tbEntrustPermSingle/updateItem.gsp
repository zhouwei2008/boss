...
<div class="main">
    ...
    <g:form action="edit" name="saveForm" useToken="true">
        <g:hiddenField name="id" value="${tbEntrustPermInstance.id}"/>
        <table align="center" class="rigt_tebl">
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: tbEntrustPermInstance, field: 'accountname', 'errors')}"><g:select name="accountname" from="${bankNameList}" optionKey="${2}" optionValue="${2}" value="${tbEntrustPermInstance?.accountname}" noSelection="${['':'-请选择-']}" class="right_top_h2_input"/></td>
            </tr>
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: tbEntrustPermInstance, field: 'entrustStarttime', 'errors')}"><g:textField id ="entrustStarttime" name="entrustStarttime" value="${tbEntrustPermInstance?.entrustStarttime.format('yyyy-MM-dd')}"  onchange="checkEntrustIsEffect()"/></td>
            </tr>

            <tr>
                <td class="right label_name"><g:message code="tbEntrustPerm.entrustEndtime.label"/><font color="red">*</font>：</td>
                <td class="${hasErrors(bean: tbEntrustPermInstance, field: 'entrustEndtime', 'errors')}"><g:textField id = "entrustEndtime" name="entrustEndtime" value="${tbEntrustPermInstance?.entrustEndtime.format('yyyy-MM-dd')}" onchange="checkEntrustIsEffect()"/></td>
            </tr>
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: tbEntrustPermInstance, field: 'entrustIsEffect', 'errors')}">&nbsp;
                    <g:if test="${tbEntrustPermInstance.entrustIsEffect=='0'}">
                    ...
                    <g:if test="${tbEntrustPermInstance.entrustIsEffect=='1'}">
                    <g:radio value="0" name="entrustIsEffectRadio"  disabled="true"/>是
                    <g:radio value="1" name="entrustIsEffectRadio" checked="true" disabled="true"/>否
                    </g:if>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="border-left:none">
                    <span class="content"><input type="submit" name="button" id="button" class="rigt_button" value="修改" onclick="return validateForm()&&confirm('确认修改？')"></span>
                    <span class="button"><input type="button" class="rigt_button" value="返回" onclick="window.location.href = '${createLink(controller:'tbEntrustPermSingle', action:'showList')}';" /></span>
...
<script type="text/javascript">
    /*//修改成功，跳回修改成功的页面
    if("${flash.message}"=="代收授权账户修改成功！"){
        history.back(-2);
    }*/
      var customerNo = document.forms['saveForm'].customerNo.value;
        if (customerNo) {
