  ...
  <g:form action="update" >
    ...
    <table align="center" class="rigt_tebl">
      ...
      <tr>
        ...
        <td class="${hasErrors(bean: boSecurityEventsInstance, field: 'sketch', 'errors')}"><g:textArea rows="10" cols="16" name="sketch" maxlength="64" style="width: 303px; height: 48px;" value="${boSecurityEventsInstance?.sketch}" /></td>
      </tr>
      ...
      <tr>
        ...
        <td class="${hasErrors(bean: boSecurityEventsInstance, field: 'startDateCreated', 'errors')}"><bo:datePicker id="startDateCreated"  name="startDateCreated" precision="day" value="${boSecurityEventsInstance?.startDateCreated}" /></td>
      </tr>
      
      <tr>
        <td class="right label_name"><g:message code="boSecurityEvents.endDateCreated.label"/>：</td>
        <td class="${hasErrors(bean: boSecurityEventsInstance, field: 'endDateCreated', 'errors')}"><bo:datePicker id="endDateCreated" name="endDateCreated" precision="day" value="${boSecurityEventsInstance?.endDateCreated}" /></td>
      </tr>
      ...
      <tr>
        ...
        <td class="${hasErrors(bean: boSecurityEventsInstance, field: 'boStatus', 'errors')}">
            ...
            %{--<g:select name="status" from="${boSecurityEventsInstance.constraints.status.inList}" value="${boSecurityEventsInstance?.status}" valueMessagePrefix="boSecurityEvents.status"  /></td>--}%
      </tr>
        ...
        <td class="${hasErrors(bean: boSecurityEventsInstance, field: 'expatiate', 'errors')}">
            <g:textArea name="expatiate" rows="10" cols="16"   style="width: 488px; height: 202px;" value="${boSecurityEventsInstance?.expatiate}"/></td>
      </tr>
