...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 colspan=2 width=100 style='height:13.5pt;width:51pt'>安全事件列表<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>事件类别 </td>
            <td class=xl667821 style='border-left:none'>事件简述</td>
            <td class=xl667821 style='border-left:none'>发生时间</td>
            <td class=xl667821 style='border-left:none'>解决时间</td>
            <td class=xl667821 style='border-left:none'>事件状态</td>
        </tr>
        <g:each in="${boSecurityEventsInstanceList}" status="i" var="boSecurityEventsInstanceList">
            <tr height=18 style='height:13.5pt'>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${i+1}</td>
                 <td height=18 class=xl677821 align=right style='height:13.5pt;'>${BoSecurityEvents.boStatusMap[boSecurityEventsInstanceList?.boStatus]}</td>
                 <td height=18 class=xl677821 align=right style='height:13.5pt;'>${boSecurityEventsInstanceList?.sketch}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate date="${boSecurityEventsInstanceList?.startDateCreated}" format="yyyy-MM-dd"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate date="${boSecurityEventsInstanceList?.endDateCreated}" format="yyyy-MM-dd"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${BoSecurityEvents.boSortMap[boSecurityEventsInstanceList?.boSort]}</td>
            </tr>
        </g:each>
