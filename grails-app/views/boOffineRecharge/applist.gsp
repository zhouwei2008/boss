            ...
            <div class="table_serch">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_App_Quary}">
                            <g:actionSubmit class="right_top_h2_button_serch" action="applist" value="查询" onclick="return checkDate()"/>
                            </bo:hasPerm>
                            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_App_DL}">
                            <g:actionSubmit class="right_top_h2_button_download" action="applistDown" value="下载" onclick="return checkDate()"/>
                            </bo:hasPerm>
                        </td>
                    </tr>
                </table>
        ...
        <table align="center" class="right_list_table" id="test">
            ...
            <g:each in="${boOffineChargeInstanceList}" status="i" var="boOffineChargeInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td>
                         <g:if test="${bo.hasPerm(perm:Perm.TravelCard_ReCharge_App_View){true}}">
                ...
                <td><g:formatNumber number="${boOffineChargeInstance.amount/100}" type="currency" currencyCode="CNY"/></td>
                    ...
                    <td>
                        <bo:hasPerm perm="${Perm.TravelCard_ReCharge_App_Add}">
                            <g:if test="${boOffineChargeInstance?.authsts=='N'}"><input type="button" onclick="window.location.href = '${createLink(controller:'boOffineRecharge', action:'app', params:['id':boOffineChargeInstance?.id])}'" value="审核"/></g:if>
                            <g:if test="${boOffineChargeInstance?.authsts!='N'}"><input type="button"  value="审核" disabled="false"/></g:if>
                        </bo:hasPerm>
                    </td>
