    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <g:each in="${boOffineChargeInstanceList}" status="i" var="boOffineChargeInstance">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${boOffineChargeInstance.amount/100}" type="currency" currencyCode="CNY"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${boOffineChargeInstance.realamount/100}" type="currency" currencyCode="CNY"/></td>
