    ...
    <div class="right_top">
        <h1><img src="${resource(dir: 'images', file: 'ico_4.gif')}" width="16" height="15"><g:message code="default.list.label" args="[entityName]"/></h1>
         <g:form>
            <div class="table_serch">
                <table>
                    <tr>
                        ...
                        <td><g:textField name="amount" onblur="checkmoney(this)"   class="right_top_h2_input"/></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_Appay_Quary}">
                            <g:actionSubmit class="right_top_h2_button_serch" action="list" value="查询" onclick="return checkDate()"/>
                            </bo:hasPerm>
                            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_Appay_DL}">
            ...
            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_Appay_Add}">
