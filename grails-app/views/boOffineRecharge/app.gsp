...
<div class="main">
  ...
  <g:form>
    <table align="center" class="rigt_tebl">
      <tr>
        <th colspan="2"><g:message code="boOffineCharge.app.label" args="[entityName]"/></th>
      </tr>
      <tr>
      ...
      <tr>
       ...
       <tr>
        ...
        <tr>
        <td class="right label_name"><g:message code="boOffineCharge.recepit.label"/>：</td>
        <td class="${hasErrors(bean: boOfflineChargeInstance, field: 'recepit', 'errors')}">
            <g:textField name="recepit" maxlength="20" value="${boOfflineChargeInstance?.recepit}"/>
        </td>
      </tr>
          <tr>
        <td class="right label_name"><g:message code="boOffineCharge.billref.label"/>：</td>
        <td class="${hasErrors(bean: boOfflineChargeInstance, field: 'billref', 'errors')}">
            <g:textField name="billref" maxlength="20" value="${boOfflineChargeInstance?.billref}"/>
        </td>
      </tr>

            <tr>
        <td class="right label_name"><g:message code="boOffineCharge.billdate.label"/>：</td>
        <td class="${hasErrors(bean: boOfflineChargeInstance, field: 'billdate', 'errors')}">
            <g:textField name="billdate" style="width:80px" onblur="value=value.replace(/[ ]/g,'')"  value="${params.billdate}" class="right_top_h2_input"/>
        </td>
      </tr>
        ...
        <tr>
           <td class="right label_name"><g:message code="boOffineCharge.authdesc.label"/>：</td>
           <td class="${hasErrors(bean: boOfflineChargeInstance, field: 'authdesc', 'errors')}">
               <g:textArea id ="authdesc" name="authdesc" maxlength="100" rows="5" cols="6" onblur="checkValid()" value="${boOfflineChargeInstance?.authdesc}"/>
           </td>
         </tr>
      <tr>
            ...
            <td colspan="2" align="center">
              ...
              <span class="button"><bo:hasPerm perm="${Perm.TravelCard_ReCharge_App_pass}"><g:actionSubmit class="rigt_button" action="appsave" value="通过" onclick="{if(confirm('确定提交?')){return true;}return false;}"/></bo:hasPerm></span>
              <span class="button"><bo:hasPerm perm="${Perm.TravelCard_ReCharge_App_refuse}"><g:actionSubmit class="rigt_button" action="refuse" value="拒绝" onclick="{if(confirm('确定提交?')){return true;}return false;}"/></bo:hasPerm></span>
            </td>
