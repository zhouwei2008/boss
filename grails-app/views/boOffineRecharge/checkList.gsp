...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'boOffineCharge.applist.label', default: 'boOffineCharge')}"/>
            ...
            <div class="table_serch">
                <table>
                    <tr>
                        ...
                        <td><p><g:textField name="creator_name" value="${params.creator_name}" class="right_top_h2_input"/></p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>${message(code: 'boOffineCharge.trxtype.label')}：</td>
                        <td><p><g:select name="trxtype" from="${BoOfflineCharge.trxtypeMap}" value="${params.trxtype}" noSelection="${['':'-全部-']}" optionKey="key" optionValue="value" class="left_top_h2_input"/></p></td>
                         <td>${message(code: 'boOffineCharge.author_name.label')}：</td>
                        <td><p><g:textField name="author_name" value="${params.author_name}" class="right_top_h2_input"/></p></td>
                    </tr>
                    <tr>
                        ...
                        <td>${message(code: 'boOffineCharge.apptime.label')}：</td>
                        ...
                        <td>
                            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_AppQuary_Quary}">
                            <g:actionSubmit class="right_top_h2_button_serch" action="checkList" value="查询" onclick="return checkDate()"/>
                             </bo:hasPerm>
                            <bo:hasPerm perm="${Perm.TravelCard_ReCharge_AppQuary_DL}">
                            <g:actionSubmit class="right_top_h2_button_download" action="checkListDown" value="下载" onclick="return checkDate()"/>
                            </bo:hasPerm>
                        </td>
                    </tr>
                </table>
        ...
        <table align="center" class="right_list_table" id="test">
            <tr>
                ...
                <g:sortableColumn params="${params}" property="creator_name" title="${message(code: 'boOffineCharge.creator.label', default: 'creator_name')}"/>
                 ...
                 <g:sortableColumn params="${params}" property="author_name" title="${message(code: 'boOffineCharge.author_name.label', default: 'author_name')}"/>
            ...
            <g:each in="${boOffineChargeInstanceList}" status="i" var="boOffineChargeInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td>
                        ...
                        <g:if test="${boOffineChargeInstance?.trxtype=='void'}">撤销</g:if>
                      </td>
                    ...
                    <td>${fieldValue(bean: boOffineChargeInstance, field: "author_name")}</td>

                    <td>
                         <g:if test="${bo.hasPerm(perm:Perm.TravelCard_ReCharge_AppQuary_View){true}}">
                  ...
                  <td>
                      ￥<g:if test="${boOffineChargeInstance.trxtype=='void'}">-</g:if>${StringUtil.getAmountFromNum(String.valueOf(boOffineChargeInstance.amount))}
                  </td>
                    <td>
                    ￥<g:if test="${boOffineChargeInstance.trxtype=='void'}">-</g:if>${StringUtil.getAmountFromNum(String.valueOf(boOffineChargeInstance.realamount))}
