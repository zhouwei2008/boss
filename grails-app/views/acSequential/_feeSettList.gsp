<%@ page import="ismp.CmCustomer; account.AcAccount; dsf.TbAgentpayDetailsInfo; dsf.TbAgentpayDetailsInfo;boss.BoAcquirerAccount" %>
...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>商户手续费结算管理<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>结算金额（元）</td>
        </tr>
        <g:each in="${boCustomerServiceInstanceList}" status="i" var="boCustomerServiceInstance">
            <tr height=18 style='height:13.5pt'>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${CmCustomer.get(boCustomerServiceInstance?.customerId).customerNo}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${CmCustomer.get(boCustomerServiceInstance?.customerId).name}</td>
                ...
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${AcAccount.findByAccountNo(boCustomerServiceInstance.feeAccNo)?.balance==null?0:AcAccount.findByAccountNo(boCustomerServiceInstance.feeAccNo)?.balance/100}</td>
            </tr>
        </g:each>
