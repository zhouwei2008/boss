...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>网关支付管理<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>支付状态</td>

            <td class=xl667821 style='border-left:none'>支付创建时间</td>
            <td class=xl667821 style='border-left:none'>收单交易日期</td>
        </tr>
        <g:each in="${gwTransList}" status="i" var="gwTransInstance">
            <tr height=18 style='height:13.5pt'>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${gwTransInstance?.id}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${gwTransInstance.order?.id}</td>
                <td class=xl677821 align=right style='border-left:none'>${gwTransInstance?.bankTransNo}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${gwTransInstance.order?.outTradeNo}</td>
                <td class=xl707821 style='border-left:none'>${gwTransInstance?.acquirerCode}</td>

                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${gwTransInstance?.authNo}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${gwTransInstance?.buyerCustomerNo}</td>
                <td class=xl677821 align=right style='border-left:none'>${gwTransInstance?.acquirerInnerAccountNo}</td>
                <td class=xl727821 style='border-left:none'>${gwTransInstance?.amount/100}</td>
                <td class=xl707821 style='border-left:none'>${GwTransaction.statusMap[gwTransInstance?.status]}</td>

                <td class=xl707821 style='border-left:none'><g:formatDate date="${gwTransInstance?.dateCreated}" format="yyyy-MM-dd HH:mm:ss"/></td>
                <td class=xl707821 style='border-left:none'>${gwTransInstance?.acquirerDate}</td>
            </tr>
        </g:each>
