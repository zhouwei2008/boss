        ...
        <table align="center" class="rigt_tebl">
            ...
            <g:if test="${flag=='0'}">
                <tr>
                    ...
                    <td class="${hasErrors(bean: ftFeeChannelInstance, field: 'name', 'errors')}"><g:select name="code" from="${BoMerchant.findAll()}" optionKey="serviceCode" optionValue="${{it.acquireName+' -- '+it.serviceCode}}" noSelection="${['':'-请选择-']}" value="${ftFeeChannelInstance?.code}" onchange="updateCode()"/></td>
                </tr>
            </g:if>
            ...
            <g:if test="${flag=='1'}">
                <tr>
                    <td class="right label_name"><g:message code="ftFeeChannel.name.label"/>：</td>
                    <td class="${hasErrors(bean: ftFeeChannelInstance, field: 'name', 'errors')}">
                        <g:select name="code" from="${FtFeeChannel.dsfMap}" optionKey="key" optionValue="value" noSelection="${['':'-请选择-']}" value="${ftFeeChannelInstance?.code}" onchange="updateCode()"/>
                    </td>
                </tr>
            </g:if>
