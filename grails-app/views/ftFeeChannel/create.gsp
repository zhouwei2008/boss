        ...
        <table align="center" class="rigt_tebl">
            ...
            <g:if test="${flag=='0'}">
                <tr>
                    ...
                    <td class="${hasErrors(bean: ftFeeChannelInstance, field: 'name', 'errors')}"><g:select name="name" from="${BoMerchant.findAll()}" optionKey="id" optionValue="${{it.acquireName+' -- '+it.serviceCode}}" noSelection="${['':'-请选择-']}" value="${ftFeeChannelInstance?.name}"/></td>
                </tr>
            </g:if>
            ...
            <g:if test="${flag=='1'}">
                <tr>
                    ...
                    <td class="${hasErrors(bean: ftFeeChannelInstance, field: 'name', 'errors')}">
                        <g:select name="name" from="${FtFeeChannel.dsfMap}" optionKey="key" optionValue="value" noSelection="${['':'-请选择-']}" value="${ftFeeChannelInstance?.name}"/>
                    </td>
                </tr>
            </g:if>
