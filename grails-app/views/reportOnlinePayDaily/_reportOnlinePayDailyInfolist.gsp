...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 colspan=2 width=100 style='height:13.5pt;width:51pt'>在线支付业务统计报表<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            <td class=xl637821>总银行卡交易笔数：${sumList.tbpn}</td>
            <td class=xl637821>总银行卡交易金额：<g:formatNumber number="${sumList.tbpa?sumList.tbpa/100:0}" type="currency" currencyCode="CNY"/></td>
            <td class=xl637821>总吉高账户余额交易笔数：${sumList.tlpn}</td>
            <td class=xl637821>总吉高账户余额交易金额：<g:formatNumber number="${sumList.tlpa?sumList.tlpa/100:0}" type="currency" currencyCode="CNY"/>}</td>
            <td class=xl637821>总银行卡退款笔数：${sumList.tbrn}</td>
            <td class=xl637821>总银行卡退款金额：<g:formatNumber number="${sumList.tbra?sumList.tbra/100:0}" type="currency" currencyCode="CNY"/></td>
            <td class=xl637821>总吉高账户余额退款笔数：${sumList.tlrn}</td>
            <td class=xl637821>总吉高账户余额退款金额：<g:formatNumber number="${sumList.tlra?sumList.tlra/100:0}" type="currency" currencyCode="CNY"/></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>银行卡交易笔数</td>
            <td class=xl667821 style='border-left:none'>银行卡交易金额</td>
            <td class=xl667821 style='border-left:none'>吉高账户余额交易笔数</td>
            <td class=xl667821 style='border-left:none'>吉高账户余额交易金额</td>
            <td class=xl667821 style='border-left:none'>银行卡退款笔数</td>
            <td class=xl667821 style='border-left:none'>银行卡退款金额</td>
            <td class=xl667821 style='border-left:none'>吉高账户余额退款笔数</td>
            <td class=xl667821 style='border-left:none'>吉高账户余额退款金额</td>
        ...
        <g:each in="${list}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.BPN}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${item.BPA?item.BPA/100:0}" type="currency" currencyCode="CNY"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.LPN}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${item.LPA?item.LPA/100:0}" type="currency" currencyCode="CNY"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.BRN}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${item.BRA?item.BRA/100:0}" type="currency" currencyCode="CNY"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.LRN}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${item.LRA?item.LRA/100:0}" type="currency" currencyCode="CNY"/></td>
