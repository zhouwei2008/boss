...
<div id="template_26326" align=center x:publishsource="Excel">
     ...
     <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>商旅商户交易汇总报表<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr>
            ...
            <td class=xl667821 style='border-left:none;width:1500px'>支付金额</td>
            <td class=xl667821 style='border-left:none;width:1500px'>支付退款笔数</td>
            <td class=xl667821 style='border-left:none;width:1500px'>支付退款金额(-)</td>
        ...
        <g:each in="${result}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                ...
                <td class=xl677821 align=right style='border-left:none'>${item.get('MERCHANT_NAME')}</td>
                ...
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${item.get('REBATES')?item.get('REBATES')/100:0}</td>
