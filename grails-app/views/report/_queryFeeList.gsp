...
<div id="template_26326" align=center x:publishsource="Excel">
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821 style='border-collapse:collapse;table-layout:fixed;width:1143pt'>
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 colspan=2 width=100 style='height:13.5pt;width:51pt'>系统手续费日报表<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            <td class=xl637821>收入手续费笔数：${in_co}</td>
            <td class=xl637821>收入手续费金额：${in_am/100}</td>
            <td class=xl637821>返回手续费笔数：${out_co}</td>
            <td class=xl637821>返回手续费金额：${out_am/100}</td>
        </tr>
         <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>收入手续费笔数</td>
            <td class=xl667821 style='border-left:none'>收入手续费金额</td>
             <td class=xl667821 style='border-left:none'>返回手续费笔数</td>
            <td class=xl667821 style='border-left:none'>返回手续费金额</td>
        </tr>
         <g:each in="${result}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.IN_CO}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${item?.IN_AM/100}" type="currency" currencyCode="CNY"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.OUT_CO}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatNumber number="${item?.OUT_AM/100}" type="currency" currencyCode="CNY"/></td>
            </tr>
        </g:each>
