  ...
  <body>
       <div id="template_26326" align=center x:publishsource="Excel">
        ...
        <tr height=18 style='height:13.5pt'>
            <td height=18 class=xl637821 colspan=2 width=100 style='height:13.5pt;width:51pt'>客户交易日报表<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr height=18 style='height:13.5pt'>
         ...
         <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td height=18 class=xl667821 style='height:13.5pt;width:150px'>客户</td>
         ...
         <g:each in="${result}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.PAYEE_NAME}</td>
