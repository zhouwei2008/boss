...
<div id="template_26326" align=center x:publishsource="Excel">
     ...
     <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>商旅账户交易明细<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr>
            <td class=xl667821 style='border-left:none'>开始日期</td>
            <td class=xl667821 style='border-left:none'>结束日期</td>
            <td class=xl667821 style='border-left:none'>账户号</td>
            <td class=xl667821 style='border-left:none'>业务类型</td>
            <td class=xl667821 style='border-left:none'>充值金额</td>
            <td class=xl667821 style='border-left:none'>支付金额</td>
            <td class=xl667821 style='border-left:none'>退款金额</td>
            <td class=xl667821 style='border-left:none'>撤销金额</td>
        </tr>
        <g:each in="${result}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                <td class=xl677821 align=right style='border-left:none'>${params.startDateCreated}</td>
                <td class=xl677821 style='border-left:none'>${params.endDateCreated}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item?.ACCOUNT_NO}</td>
                <td class=xl677821 style='border-left:none'>商旅账户</td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${item.get('V_CHARGE')?item.get('V_CHARGE')/100:0}</td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${item.get('V_PAYMENT')?item.get('V_PAYMENT')/100:0}</td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${item.get('V_REFUND')?item.get('V_REFUND')/100:0}</td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${item.get('V_VOID')?item.get('V_VOID')/-100:0}</td>
            </tr>
        </g:each>
