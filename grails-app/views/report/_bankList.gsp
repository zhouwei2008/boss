...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <g:each in="${result1}" status="i" var="trade1">
                ...
                <tr>
                    <td rowspan="6" class=xl707821 style='border-left:none'>${trade1.NAME}</td>
                    <td class=xl707821 style='border-left:none'>B2C</td>
                    ...
                    <td class=xl717821 style='border-left:none'>0</td>
                    <td class=xl717821 style='border-left:none' rowspan="6">
                    ...
                    <td class=xl717821 style='border-left:none' rowspan="6">0</td>
                    <td class=xl717821 style='border-left:none' rowspan="6">0</td>
                </tr>
                <tr id="2">
                    <td class=xl707821 style='border-left:none'>B2B</td>
                    <td class=xl717821 style='border-left:none'><g:each in="${result}" status="K2" var="trade3">
                        <g:if test="${trade3.NUM==trade1.NO && trade3.CHANNEL=='2'}">${trade3.CO}<% flag = 1 %></g:if>
                    ...
                    <td class=xl717821 style='border-left:none'><g:each in="${result}" status="K4" var="trade4">
                            <g:if test="${trade4.NUM==trade1.NO && trade4.CHANNEL=='2'}">${trade4.AM == null ? 0 : trade4.AM / 100}<% flag = 1 %></g:if>
                        </g:each>
                        <g:if test="${flag==0}">
                            0
                        </g:if>
                    ...
                    <td class=xl717821 style='border-left:none'>0</td>
                    <td class=xl717821 style='border-left:none'>
                        <g:each in="${result2}" status="r2" var="refund2">
                            <g:if test="${refund2.NO==trade1.NO && refund2.CHANNEL=='2'}">${refund2.CO}<% flag = 1 %></g:if>
                    ...
                    <td class=xl717821 style='border-left:none'>
                        <g:each in="${result2}" status="r3" var="refund3">
                            <g:if test="${refund3.NO==trade1.NO && refund3.CHANNEL=='2'}">${refund3.AM == null ? 0 : refund3.AM / 100}<% flag = 1 %></g:if>
                        </g:each>
                         <g:if test="${flag==0}">
                                0
                            </g:if>
                ...
                <tr>
                    <td class=xl707821 style='border-left:none'>代收</td>
                    <td class=xl717821 style='border-left:none'>
                        <g:each in="${result4}" status="d" var="dsf">
                            <g:if test="${dsf.ID==trade1.ID && dsf.CHANNEL=='S'}">${dsf.CO}<% j = dsf.CO ? dsf.CO : 0 %><% flag = 1 %></g:if>
                        </g:each>
                         <g:if test="${flag==0}">
                                0
                            </g:if>
                    ...
                    <td class=xl717821 style='border-left:none'>
                        <g:each in="${result4}" status="d1" var="dsf1">
                            <g:if test="${dsf1.ID==trade1.ID && dsf1.CHANNEL=='S'}">${dsf1.AM == null ? 0 : dsf1.AM}<% l = dsf1.AM ? dsf1.AM : 0 %><% flag = 1 %></g:if>
                        </g:each>
                         <g:if test="${flag==0}">
                                0
                            </g:if>
                ...
                <tr>
                    <td class=xl707821 style='border-left:none'>代付</td>
                    <td class=xl717821 style='border-left:none'>0</td>
                    <td class=xl717821 style='border-left:none'>0</td>
                    <td class=xl717821 style='border-left:none'>0</td>
                    <td class=xl717821 style='border-left:none'>
                        <g:each in="${result4}" status="d" var="dsf">
                            <g:if test="${dsf.ID==trade1.ID && dsf.CHANNEL=='F'}">${dsf.CO}<% m = dsf.CO ? dsf.CO : 0 %><% flag = 1 %></g:if>
                        </g:each>
                         <g:if test="${flag==0}">
                                0
                            </g:if>
                    ...
                    <td class=xl717821 style='border-left:none'>
                        <g:each in="${result4}" status="d1" var="dsf1">
                            <g:if test="${dsf1.ID==trade1.ID && dsf1.CHANNEL=='F'}">${dsf1.AM == null ? 0 : dsf1.AM}<% n = dsf1.AM ? dsf1.AM : 0 %><% flag = 1 %></g:if>
                        </g:each>
                         <g:if test="${flag==0}">
                                0
                            </g:if>
