...
<script type="text/javascript">
  $(function() {
    ...
    function checkDate() {
        var startDateCreated = document.getElementById('startTimeCreate').value.replace(/-/g,"//");
        var endDateCreated = document.getElementById('endTimeCreate').value.replace(/-/g,"//");
    ...
    <table align="center" class="right_list_table" id="test">
      ...
      <g:each in="${handlePayList}" status="i" var="tbPcInfoInstance">
        <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
          ...
          <td >${fieldValue(bean: tbPcInfoInstance, field: "tradeType")}</td>
