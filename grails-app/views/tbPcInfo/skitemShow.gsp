...
<div class="main">
    ...
    <table align="center" class="right_list_table" id="test">
        ...
        <div>
            ...
            合计笔数:${tbAgentpayDetailsInfoInstanceTotal}&nbsp;  金额：<g:formatNumber number="${totalMoney}" format="#.##"/>手续费:<g:formatNumber number="${totalFee}" format="#.##"/>&nbsp;&nbsp;实收金额:<g:formatNumber number="${totalAccMoney}" format="#.##"/>
