<%@ page import="boss.Perm; boss.BoOperator; ismp.CmCustomerOperator; ismp.CmCustomer; ismp.CmCorporationInfo; boss.BoBranchCompany" %>
<html>
<head>
...
<div class="main">
    ...
    <g:form action="update"  name="updateForm" method="post" enctype="multipart/form-data">
        <g:hiddenField name="id" value="${cmCorporationInfoInstance?.id}"/>
        <table align="center" class="rigt_tebl">
          <tr>
            <th colspan="9"><g:message code="default.edit.label" args="[entityName]"/></th>
          </tr>
          <tr >
          ...
          <tr>
            ...
            <td colspan="2"><span class="rigt_tebl_font"><g:formatDate date="${cmCorporationInfoInstance?.dateCreated}"/></span></td>
          </tr>
          <tr>
            ...
            <td colspan="2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'status', 'errors')}"><g:select name="status" from="${CmCustomer.statusMap}" value="${cmCorporationInfoInstance?.status}" optionKey="key" optionValue="value"/></td>
            <td class="right label_name"><g:message code="cmCorporationInfo.customerCategory.label"/>：</td>
            <td class="${hasErrors(bean: cmCorporationInfoInstance, field: 'customerCategory', 'errors')}"><g:select name="customerCategory" from="${CmCustomer.customerCategoryMap}" value="${cmCorporationInfoInstance?.customerCategory}" optionKey="key" optionValue="value"/></td>
          </tr>
          <tr>
            <td class="right label_name"><g:message code="cmCorporationInfo.registrationName.label"/><font color="red">*</font>：</td>
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'registrationName', 'errors')}"><g:textField name="registrationName" maxlength="32" value="${cmCorporationInfoInstance?.registrationName}"/></td>
            ...
            <td colspan = "2"><g:textField name="defaultEmail" maxlength="50" value="${CmCustomerOperator.findWhere(roleSet:'1',status: 'normal',customer: cmCorporationInfoInstance)?.defaultEmail}"/></td>
          </tr>
          <tr>
            ...
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'companyWebsite', 'errors')}"><g:textField name="companyWebsite" maxlength="50" value="${cmCorporationInfoInstance?.companyWebsite}"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td colspan="2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'belongToBusiness', 'errors')}">
                %{--<g:textField name="belongToBusiness" maxlength="20" value="${cmCorporationInfoInstance?.belongToBusiness}"/>--}%
          ...
          <tr>
            ...
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'belongToArea', 'errors')}"><g:textField name="belongToArea" maxlength="200" value="${cmCorporationInfoInstance?.belongToArea}"/></td>
            <td class="right label_name">商户等级：</td>
            ...
            <td colspan = "2"><g:select name="fraud_check" from="${CmCorporationInfo.fraudcheckMap}" value="${cmCorporationInfoInstance?.fraud_check}" optionKey="key" optionValue="value"/></td>
          </tr>
              <tr>
            <td class="right label_name">支付单笔交易限额(元)<font color="red">*</font>：</td>
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'qutor', 'errors')}"><g:textField name="qutor" maxlength="20" onkeyup="this.value=this.value.replace(/[^\\d]/g,'')"  onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')"  value="${cmCorporationInfoInstance?.qutor}"/></td>
            <td class="right label_name">支付单日累计交易限额(元)<font color="red">*</font>：</td>
           <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'dayQutor', 'errors')}"><g:textField name="dayQutor" maxlength="20" onkeyup="this.value=this.value.replace(/[^\\d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" value="${cmCorporationInfoInstance?.dayQutor}"/></td>
            <td class="right label_name">支付单月累计交易限额(元)<font color="red">*</font>：</td>
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'monthQutor', 'errors')}"><g:textField name="monthQutor" maxlength="20" onkeyup="this.value=this.value.replace(/[^\\d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" value="${cmCorporationInfoInstance?.monthQutor}"/></td>
          </tr>

             <tr>
            <td class="right label_name">支付单日交易笔数<font color="red">*</font>：</td>
            <td colspan = "8" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'qutorNum', 'errors')}"><g:textField name="qutorNum" maxlength="20" onkeyup="this.value=this.value.replace(/[^\\d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" value="${cmCorporationInfoInstance?.qutorNum}"/></td>
            </tr>
        ...
        <tr>
            ...
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'identityType', 'errors')}"><g:select name="identityType" from="${CmCorporationInfo.identityTypeMap}" value="${cmCorporationInfoInstance.identityType}" optionKey="key" optionValue="value"/></td>
        ...
        <tr>
            ...
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'idPositivePhoto', 'errors')}">
                <input type="file" name="idPositivePhotoFile" id="idPositivePhotoFile" value="${cmCorporationInfoInstance?.idPositivePhoto}"/>
                <input type="hidden" name="idPositivePhoto" value="${cmCorporationInfoInstance?.idPositivePhoto}" />
                ...
                <g:if test="${cmCorporationInfoInstance?.idPositivePhoto !=null && cmCorporationInfoInstance?.idPositivePhoto != ''}">
                    <bo:hasPerm perm="${Perm.Real_Name_Authentication_View}">
                        <span><g:link action="preview" params="[idPositivePhoto:cmCorporationInfoInstance?.idPositivePhoto]" target="_blank">浏览</g:link></span>
                    </bo:hasPerm>

                    <g:if test="${cmCorporationInfoInstance?.idPositiveReview == null ||cmCorporationInfoInstance?.idPositiveReview == '' || cmCorporationInfoInstance?.idPositiveReview == 'wait'}">
                        <bo:hasPerm perm="${Perm.Real_Name_Authentication_Review}">
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,idPositiveReview:'pass']">通过</g:link></span>
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,idPositiveReview:'refuse']">拒绝</g:link></span>
                        </bo:hasPerm>
                    </g:if>
                </g:if>
            </td>
            <td class="right label_name">证件背面照：</td>
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'idOppositePhoto', 'errors')}">
                <input type="file" name="idOppositePhotoFile" id="idOppositePhotoFile"  value="${cmCorporationInfoInstance?.idOppositePhoto}"/>
                <input type="hidden" name="idOppositePhoto" value="${cmCorporationInfoInstance?.idOppositePhoto}" />
                ...
                <g:if test="${cmCorporationInfoInstance?.idOppositePhoto !=null && cmCorporationInfoInstance?.idOppositePhoto != ''}">
                    <bo:hasPerm perm="${Perm.Real_Name_Authentication_View}">
                       <span><g:link action="preview" params="[idOppositePhoto:cmCorporationInfoInstance?.idOppositePhoto]" target="_blank">浏览</g:link></span>
                    </bo:hasPerm>
                    <g:if test="${cmCorporationInfoInstance?.idOppositeReview == null ||cmCorporationInfoInstance?.idOppositeReview == '' || cmCorporationInfoInstance?.idOppositeReview == 'wait'}">
                        <bo:hasPerm perm="${Perm.Real_Name_Authentication_Review}">
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,idOppositeReview:'pass']">通过</g:link></span>
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,idOppositeReview:'refuse']">拒绝</g:link></span>
                        </bo:hasPerm>
                    </g:if>
                </g:if>
            </td>
        ...
        <tr>
            ...
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'businessLicensePhoto', 'errors')}">
                <input type="file" name="businessLicensePhotoFile" id="businessLicensePhotoFile" value="${cmCorporationInfoInstance?.businessLicensePhoto}"/>
                <input type="hidden" name="businessLicensePhoto" value="${cmCorporationInfoInstance?.businessLicensePhoto}" />
                ...
                <g:if test="${cmCorporationInfoInstance?.businessLicensePhoto !=null && cmCorporationInfoInstance?.businessLicensePhoto != ''}">
                    <bo:hasPerm perm="${Perm.Real_Name_Authentication_View}">
                       <span><g:link action="preview" params="[businessLicensePhoto:cmCorporationInfoInstance?.businessLicensePhoto]" target="_blank">浏览</g:link></span>
                    </bo:hasPerm>

                    <g:if test="${cmCorporationInfoInstance?.businessLicenseReview == null ||cmCorporationInfoInstance?.businessLicenseReview == '' || cmCorporationInfoInstance?.businessLicenseReview == 'wait'}">
                        <bo:hasPerm perm="${Perm.Real_Name_Authentication_Review}">
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,businessLicenseReview:'pass']">通过</g:link></span>
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,businessLicenseReview:'refuse']">拒绝</g:link></span>
                        </bo:hasPerm>
                    </g:if>
                </g:if>
            ...
            <td colspan = "2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'taxRegistrationPhoto', 'errors')}">
                <input type="file" name="taxRegistrationPhotoFile" id="taxRegistrationPhotoFile" value="${cmCorporationInfoInstance?.taxRegistrationPhoto}"/>
                <input type="hidden" name="taxRegistrationPhoto" value="${cmCorporationInfoInstance?.taxRegistrationPhoto}" />
                ...
                <g:if test="${cmCorporationInfoInstance?.taxRegistrationPhoto !=null && cmCorporationInfoInstance?.taxRegistrationPhoto != ''}">
                    <bo:hasPerm perm="${Perm.Real_Name_Authentication_View}">
                        <span><g:link action="preview" params="[taxRegistrationPhoto:cmCorporationInfoInstance?.taxRegistrationPhoto]" target="_blank">浏览</g:link></span>
                    </bo:hasPerm>
                    <g:if test="${cmCorporationInfoInstance?.taxRegistrationReview == null ||cmCorporationInfoInstance?.taxRegistrationReview == '' || cmCorporationInfoInstance?.taxRegistrationReview == 'wait'}">
                        <bo:hasPerm perm="${Perm.Real_Name_Authentication_Review}">
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,taxRegistrationReview:'pass']">通过</g:link></span>
                            <span><g:link action="reviewPhoto" params="[id:cmCorporationInfoInstance.id,taxRegistrationReview:'refuse']">拒绝</g:link></span>
                        </bo:hasPerm>
                    </g:if>
                </g:if>
            </td>
          ...
          <tr>
            ...
            <td colspan = "8" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'businessScope', 'errors')}"><g:textArea style="width:80%" name="businessScope" cols="5" rows="5" value="${cmCorporationInfoInstance?.businessScope}"/></td>
          </tr>
        ...
        <td colspan = "8" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'isViewDate', 'errors')}" ><g:checkBox name="isViewDate" value="${cmCorporationInfoInstance?.isViewDate}"/></td>
          ...
          <tr>
            ...
            <td colspan="3" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'officeLocation', 'errors')}"><g:textField style="width:97%" name="officeLocation" maxlength="200" value="${cmCorporationInfoInstance?.officeLocation}"/></td>
            <td class="right label_name"><g:message code="cmCorporationInfo.companyPhone.label"/>：</td>
            <td colspan="1" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'companyPhone', 'errors')}"><g:textField name="companyPhone" maxlength="20" value="${cmCorporationInfoInstance?.companyPhone}"/></td>
            <td class="right label_name"><g:message code="cmCorporationInfo.zipCode.label"/>：</td>
            <td colspan="2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'zipCode', 'errors')}"><g:textField name="zipCode" maxlength="10" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onkeyup="value=value.replace(/[\\^]|[^0-9]/g, '')" value="${cmCorporationInfoInstance?.zipCode}"/></td>
          </tr>
          <tr>
            <td class="right label_name"><g:message code="cmCorporationInfo.bizMan.label"/><font color="red">*</font>：</td>
            <td class="${hasErrors(bean: cmCorporationInfoInstance, field: 'bizMan', 'errors')}"><g:textField name="bizMan" maxlength="32" value="${cmCorporationInfoInstance?.bizMan}"/></td>
            <td class="right label_name"><g:message code="cmCorporationInfo.bizMPhone.label"/><font color="red">*</font>：</td>
            <td class="${hasErrors(bean: cmCorporationInfoInstance, field: 'bizMPhone', 'errors')}"><g:textField name="bizMPhone" maxlength="20" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onkeyup="value=value.replace(/[\\^]|[^0-9]/g, '')" value="${cmCorporationInfoInstance?.bizMPhone}"/></td>
            <td class="right label_name"><g:message code="cmCorporationInfo.bizPhone.label"/>：</td>
            <td class="${hasErrors(bean: cmCorporationInfoInstance, field: 'bizPhone', 'errors')}"><g:textField name="bizPhone" maxlength="20" value="${cmCorporationInfoInstance?.bizPhone}"/></td>
            <td class="right label_name"><g:message code="cmCorporationInfo.bizEmail.label"/>：</td>
            <td colspan="2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'bizEmail', 'errors')}"><g:textField name="bizEmail" maxlength="30" value="${cmCorporationInfoInstance?.bizEmail}"/></td>
          </tr>
          <tr>
            ...
            <td class="${hasErrors(bean: cmCorporationInfoInstance, field: 'techMPhone', 'errors')}"><g:textField name="techMPhone" maxlength="20" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onkeyup="value=value.replace(/[\\^]|[^0-9]/g, '')" value="${cmCorporationInfoInstance?.techMPhone}"/></td>
          ...
          <tr>
            ...
            <td class="${hasErrors(bean: cmCorporationInfoInstance, field: 'financeMPhone', 'errors')}"><g:textField name="financeMPhone" maxlength="20" onafterpaste="this.value=this.value.replace(\\[^d]/g,'')" onblur="value=value.replace(/[\\^]|[^0-9]/g, '')" onkeyup="value=value.replace(/[\\^]|[^0-9]/g, '')" value="${cmCorporationInfoInstance?.financeMPhone}"/></td>
          ...
          <tr >
            ...
            <td colspan="2" class="${hasErrors(bean: cmCorporationInfoInstance, field: 'corporate', 'errors')}"></td>
              %{--<g:message code="cmCorporationInfo.corporate.label"/>--}%
              %{--<g:textField name="corporate" maxlength="32" value="${cmCorporationInfoInstance?.corporate}"/>--}%
          </tr>
          <tr >
          ...
          <tr>
            ...
            <tr>
                <td colspan="9" align="center">
                    ...
                    <span class="content"><input type="button" name="button" id="button" onclick="onSubmit();" class="rigt_button" value="确定"></span>
                </td>
            </tr>
        </table>
