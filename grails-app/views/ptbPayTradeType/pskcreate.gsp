...
<head>
  ...
  <g:set var="entityName" value="${message(code: '收款交易类型创建', default: '收款交易类型创建')}"/>
...
<div class="main">
  ...
  <div class="right_top">
    ...
    <table align="center" class="rigt_tebl">
      <tr>
        <th colspan="2">收款交易类型创建</th>
      </tr>
       %{--<tr>
        <td class="right label_name">收款类型：</td>
        <td>
           &nbsp;&nbsp;收款
        </td>
      </tr>--}%
      ...
      <g:hiddenField name="payType" value="S"/>
      <tr>
