...
<div class="main">
  ...
  <div class="right_top">
    ...
    <h2>
      <g:form>
        <bo:hasPerm perm="${Perm.AgPay_BankChannel_New}"><g:actionSubmit class="right_top_h2_button_tj" action="dkbind" value="${message(code: 'default.new.label', args:[entityName])}"/></bo:hasPerm>
      </g:form>
    </h2>
