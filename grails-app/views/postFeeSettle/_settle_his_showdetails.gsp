...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>结算历史交易记录查看列表<span style='mso-spacerun:yes'>&nbsp;</span></td>
            ...
            <td class=xl637821 width=136 style='width:102pt'></td>
            <td class=xl637821 width=136 style='width:102pt'></td>
            <td class=xl637821 width=136 style='width:122pt'></td>
            <td class=xl637821 width=80 style='width:60pt'></td>
            <td class=xl637821 width=136 style='width:102pt'></td>
        ...
        <g:each in="${ftTradeFeeList}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>
                      <g:if test="${cu instanceof ismp.CmCorporationInfo}">${cu?.registrationName}</g:if>
                      <g:else>${cu?.name}</g:else>
                </td>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate format="yyyy.MM.dd HH:mm:ss" date="${item.BILL_DATE}"/></td>
                <td height=18 class=xl657821 align=right style='height:13.5pt;'><g:formatDate format="yyyy.MM.dd HH:mm:ss" date="${item.TRADE_DATE}"/></td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'>${item.AMOUNT / 100}</td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'><g:if test="${item.POST_FEE}">${item.POST_FEE / 100}</g:if><g:elseif test="${item.PRE_FEE}">${item.PRE_FEE / 100}</g:elseif></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'></td>
            </tr>
        </g:each>
