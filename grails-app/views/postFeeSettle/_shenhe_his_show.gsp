...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>后返商户手续费结算历史明细查看列表<span style='mso-spacerun:yes'>&nbsp;</span></td>
            ...
            <td class=xl637821 width=100 style='width:72pt'>总笔数:</td>
            <td class=xl637821 width=136 style='width:102pt'>${total}笔</td>
            <td class=xl637821 width=136 style='width:120pt'>金额总计:</td>
            <td class=xl637821 width=136 style='width:102pt'>${amountTotal/100}元</td>
            <td class=xl637821 width=80 style='width:60pt;'>手续费金额总计:</td>
            <td class=xl637821 width=136 style='width:102pt'>${postFeeTotal/100}元</td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>订单时间</td>
            <td class=xl667821 style='border-left:none'>支付时间</td>
            <td class=xl667821 style='border-left:none'>金额</td>
            <td class=xl667821 style='border-left:none'>手续费金额</td>
            <td class=xl667821 style='border-left:none'>支付渠道</td>
        </tr>
        <g:each in="${ftTradeFeeList}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${ismp.CmCustomer.findByCustomerNo(item.CUSTOMER_NO)?.name}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.SEQ_NO}</td>
                <td height=18 class=xl657821 align=right style='height:13.5pt;'></td>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate format="yyyy.MM.dd" date="${item.TRADE_DATE}" /></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate format="yyyy.MM.dd" date="${item.BILL_DATE}" /></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;mso-number-format:"\#\,\#\#0\.00";'>${item.AMOUNT/100}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;mso-number-format:"\#\,\#\#0\.00";'><g:if test="${item.POST_FEE}">${item.POST_FEE/100}</g:if></td>
