...
<div class="main">
    ...
    <div class="right_top">
        ...
        <div align="center">
            <input type="button" onclick="window.location.href = '${createLink(controller:'postFeeSettle', action:'settle_list',params:['mid':customerNo,'start':startDate,'end':endDate])}'" value="返回"/>
        </div>
    </div>
</div>
</body>
