    ...
    <g:form action="update">
        ...
        <table align="center" class="rigt_tebl">
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: boOperatorInstance, field: 'account', 'errors')}"><g:textField name="account" maxlength="20" value="${boOperatorInstance?.account}"/></td>
            </tr>

            <tr>
                <td class="right label_name"><g:message code="boOperator.name.label"/>：</td>
                <td class="${hasErrors(bean: boOperatorInstance, field: 'name', 'errors')}"><g:textField name="name" maxlength="30" value="${boOperatorInstance?.name}"/></td>
            </tr>

            <tr>
                <td class="right label_name"><g:message code="boOperator.password.label"/>：</td>
                <td class="${hasErrors(bean: boOperatorInstance, field: 'password', 'errors')}"><g:passwordField name="password"/>
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: boOperatorInstance, field: 'mobile', 'errors')}"><g:textField name="mobile" value="${boOperatorInstance?.mobile}"/></td>
            </tr>

            <tr>
                <td class="right label_name"><g:message code="boOperator.email.label"/>：</td>
                <td class="${hasErrors(bean: boOperatorInstance, field: 'email', 'errors')}"><g:textField name="email" value="${boOperatorInstance?.email}"/></td>
            </tr>
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: boOperatorInstance, field: 'role', 'errors')}"><g:select from="${BossRole.list()}"  style="width:170px" optionKey="id" optionValue="roleName" name="role.id" value="${boOperatorInstance?.role?.id}"/></td>
            </tr>
		...
		<g:select name="branchCompany" from="${BoBranchCompany.list()}"  style="width:170px" optionKey="id" optionValue="companyName" noSelection="${['':'-请选择-']}" value="${boOperatorInstance?.branchCompany}"/>
		</td>
            %{--<tr>--}%
		...
		%{--<g:select name="belongToSale" from="${sales}"  style="width:170px"  noSelection="${['':'-请选择-']}" value="${boOperatorInstance?.belongToSale}"/>--}%
		%{--</td>--}%
            %{--</tr>--}%
