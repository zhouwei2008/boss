...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>充值撤销审核明细<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            <td height=18 class=xl667821 style='height:13.5pt;width:150px'>${message(code: 'boRevocationApplyApprove.trxtype.label', default: 'trxtype')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.account.label', default: 'accountNo')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.accountName.label', default: 'accountName')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.branchname.label', default: 'branchname')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.createtime.label', default: 'createtime')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.apptime.label', default: 'authdate')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.creator.label', default: 'creator_name')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.author.label', default: 'author_name')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.trxsqe.label', default: 'trxSeq')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.oldsqe.label', default: 'oldSeq')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.amount.label', default: 'amount')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.realamount.label', default: 'realamount')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.billmode.label', default: 'billmode')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.status.label', default: 'status')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.authsts.label', default: 'authsts')}</td>
            <td class=xl667821 style='border-left:none'>${message(code: 'boRevocationApplyApprove.note.label', default: 'note')}</td>
        </tr>
        <g:each in="${boOffineChargeInstanceList}" status="i" var="boOffineChargeInstance">
            <tr height=18 style='height:13.5pt'>
                ...
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${boOffineChargeInstance?.author_name}</td>
