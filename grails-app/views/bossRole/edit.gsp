...
<div class="main">
  ...
  <g:form action="update" name="createForm">
    ...
    <table align="center" class="rigt_tebl">
      ...
      <tr>
        ...
        <td class="${hasErrors(bean: bossRoleInstance, field: 'roleName', 'errors')}"><g:textField name="roleName" value="${bossRoleInstance?.roleName}"/></td>
      </tr>

      <tr>
        <td class="right label_name"><g:message code="bossRole.rolePerms.label"/>：</td>
        <td class="${hasErrors(bean: bossRoleInstance, field: 'rolePerms', 'errors')}">
          <div id="tree"></div>
        </td>
      </tr>
