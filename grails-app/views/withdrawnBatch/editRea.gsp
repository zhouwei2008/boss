...
<head>
    ...
    <g:set var="entityName" value="${message(code: '提现银行选择', default: '提现银行选择')}"/>
        ...
        <table align="center" class="rigt_tebl">
            ...
            <tr>
                <td colspan="2" align="center">
                    <span class="content"><input type="button" onclick="checkReason('<%=request.getParameter("id")%>', '<%=request.getParameter("withdrawnBatchNo")%>')" id="button" class="rigt_button" value="确认"></span>
...
<script type="text/javascript">
    function checkReason(id, withdrawnBatchNo) {
        ...
        window.parent.location.href = '${createLink(controller:'withdrawnBatch', action:'selectCheckRefuse', params:['flag':'0'])}&id=' + id + '&withdrawnBatchNo=' + withdrawnBatchNo + '&note=' + note;
