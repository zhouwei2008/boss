<%@ page import="gateway.GwOrder; gateway.GwTransaction; boss.BoAccountAdjustInfo " %>
...
<div id="template_26326" align=center x:publishsource="Excel">
    ...
    <table border=0 cellpadding=0 cellspacing=0 width=1524 class=xl637821
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            width:51pt'>订单掉单管理<span style='mso-spacerun:yes'>&nbsp;</span></td>
        ...
        <tr height=18 style='height:13.5pt'>
            ...
            <td class=xl165><g:formatNumber number="${totalAmount ? totalAmount/100 : 0}" type="currency" currencyCode="CNY"/></td>
            <td class=xl637821></td>
            <td class=xl637821>数量总计：</td>
            <td class=xl637821>${totalNum ? totalNum : 0}</td>
            <td class=xl637821></td>
            <td class=xl637821></td>
            <td class=xl637821></td>
            <td class=xl637821></td>
        ...
        <tr class=xl637821 height=18 style='height:13.5pt'>
            ...
            <td class=xl667821 style='border-left:none'>订单创建时间</td>
            <td class=xl667821 style='border-left:none'>银行订单号</td>
            <td class=xl667821 style='border-left:none'>订单金额（元）</td>
            <td class=xl667821 style='border-left:none'>支付完成时间</td>
            <td class=xl667821 style='border-left:none'>卖家客户号</td>
            <td class=xl667821 style='border-left:none'>卖家客户名称</td>
            <td class=xl667821 style='border-left:none'>联系人</td>
            <td class=xl667821 style='border-left:none'>联系电话</td>
            <td class=xl667821 style='border-left:none'>管理员邮箱</td>
        </tr>
        <g:each in="${list}" status="i" var="item">
            <tr height=18 style='height:13.5pt'>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.OUTTRADENO}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.TRADENO}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate format="yyyy-MM-dd HH:mm:ss" date="${item.ORDERCREATETIME}"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${GwTransaction.findByOrder(GwOrder.get(item.ORDERID.toString()))?.bankTransNo}</td>
                <td height=18 class=xl727821 align=right style='height:13.5pt;'><g:formatNumber number="${item.ORDERAMOUNT ? item.ORDERAMOUNT/100 : 0}" type="currency" currencyCode="CNY"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'><g:formatDate format="yyyy-MM-dd HH:mm:ss" date="${item.PAYCOMPLETETIME}"/></td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.SELLERCUSTOMERNO}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.SELLERNAME}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.CONTACT}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.CONTACTPHONE}</td>
                <td height=18 class=xl677821 align=right style='height:13.5pt;'>${item.SELLERADMINMAIL}</td>
            </tr>
        </g:each>
