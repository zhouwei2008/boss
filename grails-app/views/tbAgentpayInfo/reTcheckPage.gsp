...
<head>
    ...
    <g:set var="entityName" value="${message(code: 'tbAgentpayDetailsInfo.label', default: '退款终审信息')}"/>
        ...
        function selectCheck() {
            ...
            if (flag == 0) {
                ...
                return false;
                 ...
                 var reTcheckForm = document.forms['reTcheckForm'];
                reTcheckForm.action = "reTcheck";
                parent.showWait();
                reTcheckForm.submit();
            }
...
<div class="main">
    ...
    <table align="center" class="right_list_table" >
        <g:form action="reTcheckPage" name ="reTcheckForm">
        ...
        %{--<g:sortableColumn params="${params}"  property="tradeRemark2" title="${message(code: 'tbAgentpayDetailsInfo.tradeRemark2.label', default: 'Trade Remark2')}"/>--}%
            ...
            %{--<g:sortableColumn params="${params}" property="refundFirstname" title="退款初审"/>--}%
            ...
            <g:each in="${tbAgentpayDetailsInfoInstanceList}" status="i" var="tbAgentpayDetailsInfoInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    %{--  <td nowrap>${fieldValue(bean: tbAgentpayDetailsInfoInstance, field: "refundFirstname")}</td> --}%
            ...
            <table align="center">
                ...
                <tr>
                    <td align="center">
                       %{-- <bo:hasPerm perm="${Perm.Agent_RfdFinalChk_CheckT}"><g:actionSubmit   class="right_top_h2_button_tj" action="reTcheck" value="终审通过" onclick="return selectCheck()&&confirm('确认终审通过？');"/></bo:hasPerm>--}%
                         %{--<bo:hasPerm perm="${Perm.Agent_RfdFinalChk_CheckT}"><g:actionSubmit  class="right_top_h2_button_tj" action="reTcheck" value="终审通过" onclick="return selectCheck();"/></bo:hasPerm>--}%
                        <bo:hasPerm perm="${Perm.Agent_RfdFinalChk_CheckT}"><input class="right_top_h2_button_tj" type="button" value="终审通过" onclick="selectCheck()"/></bo:hasPerm>
                    </td>
                </tr>
            </table>
        </g:form>
