<%@ page import="boss.DesUtil; boss.BoBankDic; ismp.CmCustomerBankAccount" %>
<html>
<head>
    ...
    <g:form action="update">
        ...
        <table align="center" class="rigt_tebl">
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: cmCustomerBankAccountInstance, field: 'bankAccountNo', 'errors')}"><g:textField name="bankAccountNo" maxlength="32" value="${DesUtil.decrypt(cmCustomerBankAccountInstance?.bankAccountNo,cmCustomerBankAccountInstance?.customer?.customerNo)}"/></td>
            </tr>
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: cmCustomerBankAccountInstance, field: 'status', 'errors')}">
                    <g:select name="status" from="${CmCustomerBankAccount.statusMap}" value="${cmCustomerBankAccountInstance?.status}" optionKey="key" optionValue="value"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="${hasErrors(bean: cmCustomerBankAccountInstance, field: 'isCorporate', 'errors')}">
                    ...
                    <g:select name="isCorporate" from="${CmCustomerBankAccount.isCorporateMap}" value="${cmCustomerBankAccountInstance?.isCorporate}" optionKey="key" optionValue="value"/>
                </td>
            </tr>
