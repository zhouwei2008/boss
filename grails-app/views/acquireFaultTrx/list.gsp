    ...
    <div class="right_top">
        ...
        <div class="table_serch">
            ...
            <g:form>
                <tr>
                    ...
                    <td><g:textField name="startTrxamount" value="${params.startTrxamount}" onblur="value=value.replace(/[ ]/g,'')" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" style="width:60px" class="right_top_h2_input"/>--<g:textField name="endTrxamount" onblur="value=value.replace(/[ ]/g,'')" onkeyup="if(isNaN(value))execCommand('undo')" onafterpaste="if(isNaN(value))execCommand('undo')" style="width:60px" value="${params.endTrxamount}" class="right_top_h2_input"/> </td>
                ...
                <tr>
                    ...
                    <td><g:textField name="startTrxdate" style="width:80px" onchange="checkDate()" onblur="value=value.replace(/[ ]/g,'')" value="${params.startTrxdate}" class="right_top_h2_input"/>--
                        <g:textField name="endTrxdate" onchange="checkDate()" onblur="value=value.replace(/[ ]/g,'')" value="${params.endTrxdate}" style="width:80px" class="right_top_h2_input"/> </td>
                ...
                <tr>
                    ...
                    <td><g:textField name="startAcquireDate" onchange="checkDate()" onblur="value=value.replace(/[ ]/g,'')" style="width:80px" value="${params.startAcquireDate}" class="right_top_h2_input"/>--
                         <g:textField name="endAcquireDate" onchange="checkDate()" onblur="value=value.replace(/[ ]/g,'')" style="width:80px" value="${params.endAcquireDate}" class="right_top_h2_input"/> </td>
                </tr>
                <tr>

                    <td>${message(code: 'acquireFaultTrx.createDate.label')}：  </td>
                    <td><g:textField name="startCreateDate" value="${params.startCreateDate}" onchange="checkDate()" onblur="value=value.replace(/[ ]/g,'')" style="width:80px" class="right_top_h2_input"/>--
                        <g:textField name="endCreateDate" onchange="checkDate()" onblur="value=value.replace(/[ ]/g,'')" value="${params.endCreateDate}" style="width:80px" class="right_top_h2_input"/></td>
                    <td>${message(code: 'acquireFaultTrx.changeApplier.label')}：</td>
                    <td><g:textField name="changeApplier" onblur="value=value.replace(/[ ]/g,'')" value="${params.changeApplier}" class="right_top_h2_input"/></td>
                    <td>${message(code: 'acquireFaultTrx.authOper.label')}：</td>
                    ...
                    <td>
                        ...
                        <bo:hasPerm perm="${Perm.Gworder_ExcpQry_Dl}">
        ...
        <table align="center" class="right_list_table" id="test">
            <tr>
                ...
                <g:sortableColumn params="${params}" property="changeApplier" title="${message(code: 'acquireFaultTrx.changeApplier.label', default: 'changeApplier')}"/>

                <g:sortableColumn params="${params}" property="authOper" title="${message(code: 'acquireFaultTrx.authOper.label', default: 'authOper')}"/>
            ...
            <g:each in="${acquireFaultTrxInstanceList}" status="i" var="acquireFaultTrxInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td>
                        <g:if test="${bo.hasPerm(perm:Perm.Gworder_ExcpQry_View){true}}"><g:link action="show" id="${acquireFaultTrxInstance.id}">${fieldValue(bean: acquireFaultTrxInstance, field: "trxid")}</g:link></g:if>
                    ...
                    <td>
                        ${acquireFaultTrxInstance?.acquireDate}
                    </td>
                    ...
                    <td>${fieldValue(bean: acquireFaultTrxInstance, field: "changeApplier")}</td>

                    <td>${fieldValue(bean: acquireFaultTrxInstance, field: "authOper")}</td>
